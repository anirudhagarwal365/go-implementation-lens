...
echo "   /var/folders/gj/1kfly_lx63z11tfmqtpnz26m0000gn/T/go-interface-lens.log"
echo ""
echo "💡 Debug Commands:"
echo "   • Cmd+Shift+P -> 'Go: Show Interface Lens Debug Log'"
echo "   • Cmd+Shift+P -> 'Go: Refresh Interface Lens'"
echo ""
